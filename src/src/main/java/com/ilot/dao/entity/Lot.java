...
/**
 * Persistent class for entity stored in table "lot"
 *
...
public class Lot implements Serializable, Cloneable {
	...
	// "ilotId" (column "ilot_id") is not defined by itself because used as FK in a link 
    ...
    @ManyToOne
    @JoinColumn(name="ilot_id", referencedColumnName="id")
    private Ilot ilot        ;
