...
public class OperatorEnum {
    ...
    private static final List<String> LIST_OF_ALL_OPERATORS = Arrays.asList(EQUAL, NOT_EQUAL_1, NOT_EQUAL_2, LESS_OR_EQUAL, LESS, MORE_OR_EQUAL, MORE, BETWEEN, BETWEEN_OUT, BETWEEN_LEFT_OUT, BETWEEN_RIGHT_OUT, CONTAINS, START_WTIH, END_WTIH, IN, NOT_IN, EXISTS, NOT_EXISTS, IS_NULL, FUZZY);
    ...
    private static final List<String> LIST_OF_OPERATORS_NOT_NEEDING_ANY_VALUES = Arrays.asList(EXISTS, NOT_EXISTS, IS_NULL);
