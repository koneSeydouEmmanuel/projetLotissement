...
public class Validate {
	...
	public static <T,P> Response<P> validateList(Request<T> request, Response<P> response, FunctionalError functionalError, Locale locale) throws Exception {
		boolean ostate = true;
		response.setStatus(functionalError.REQUEST_FAIL("", locale));
		if (request == null) {
			response.setHasError(ostate);
	...
	public static Boolean CompareOffMinMax(Double Min, Double Max){
