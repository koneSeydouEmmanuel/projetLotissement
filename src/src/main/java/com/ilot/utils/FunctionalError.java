...
public class FunctionalError {
    ...
    public Status CUSTOM(String message, Locale locale) {
        status.setCode(StatusMessage.FUNC_CUSTOM);
        status.setMessage(messageSource.getMessage("StatusMessage.FUNC_CUSTOM", new Object[]{}, locale) + ": " + message);
        return status;
    }
    public Status OFFMINMAX(String message, Locale locale) {
        status.setCode(StatusMessage.FUNC_CUSTOM);
        status.setMessage(messageSource.getMessage("StatusMessage.FUNC_OFFMINMAX", new Object[]{}, locale) + ": " + message);
        return status;
    }
    ...
    public Status FUNC_FAIL(String message, Locale locale) {
        Status status = new Status();
        status.setCode(StatusCode.FUNC_FAIL);
        status.setMessage(messageSource.getMessage("StatusMessage.FUNC_FAIL", new Object[] {}, locale) + message);
        return status;
    }
    ...
    public Status Message(String message, Locale locale) {
        Status status = new Status();
        status.setCode(StatusCode.MESSAGE);
