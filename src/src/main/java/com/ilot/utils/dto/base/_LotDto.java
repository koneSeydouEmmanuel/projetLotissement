...
public class _LotDto implements Cloneable {
	...
	//protected Integer    ilot;
	protected String ilotLibelle;
	...
	protected SearchParam<Integer>  ilotIdParam           ;                     
	...
	protected SearchParam<Integer>  ilotParam             ;                     
	protected SearchParam<String>   ilotLibelleParam      ;                     
